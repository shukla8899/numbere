...
@Client.on_message(filters.command("total1") & filters.private & filters.user(ADMINS))
...
@Client.on_message(filters.command("clear1") & filters.private & filters.user(ADMINS))
